...
import {I2DTextIndex, I2DTextSelection} from "./_types/I2DTextSelection";
 ...
 */
export function get2dIndex(text: string, index: number): I2DTextIndex {
 ...
 */
export function get2dSelectionRange(
    text: string,
 ...
 */
export function get1dIndex(text: string, index: I2DTextIndex): number {
    const lines = getTextLines(text);
